...
- 2026-07-09: Resolvido. `/Lotes` falhava com `Unknown column 'b.title'` porque a migration manual `AddBetTitle` nao tinha atributos EF Core de descoberta. A migration foi corrigida com `[DbContext]` e `[Migration]`, a API foi reiniciada e master/slave receberam `Bets.title`.
