...
- `CharacterPacketFactory`: monta pacotes `0x901`, `0x925`, `0x301`, `0x117`, `0x103`, `0x109`, `0x108`, `0x10A`, `0x984`, `0x305`, `0xF86` e `0x131`.
...
- `CharacterMovementService`: trata rotacao, movimento, broadcast para visiveis e refresh de mobs/NPCs.
- `ChatCommandService`: separa parsing de chat/comandos debug do handler.
...
- Ao entrar no mundo, apos `0x925`/`0x107`, o servidor tambem envia `0x108`, `0x103`, `0x109` e `0x10A` para sincronizar EXP, HP/MP, atributos e status derivados.
